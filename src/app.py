...
activities = {
    ...
    "Basketball Team": {
        ...
        "max_participants": 18,
        "participants": ["alan@mergington.edu", "maria@mergington.edu"]
    },
    "Soccer Club": {
        "description": "Outdoor soccer training and match preparation",
    ...
    "Drama Club": {
        "description": "Rehearse plays, practice acting techniques, and perform",
